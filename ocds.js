module.exports = {
        ...
        return edca_db.task(function (t) {
            ...
            return t.one("Select * from contractingprocess where id = $1", [localid]).then(function (cp) { //0
                ...
                if (type ==="release-package"){
                    ...
                    record.uri = data[0].cp.uri;
                    record.publishedDate = (new Date()).toISOString();
                    record.releases = [ release ];
                    record.publisher = publisher;
                    record.license = data[0].cp.license;
                    record.publicationPolicy = data[0].cp.publicationpolicy;
    ...
    /* OCDS 1.1 */
    getOCDSv1_1: function ( localid, type, edca_db ) {
